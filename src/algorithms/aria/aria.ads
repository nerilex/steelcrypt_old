...
package ARIA is
   ...
   package ARIA_128 is new Block_Cipher_Generic
     (Name_Intern            => "ARIA-128",
   ...
   package ARIA_192 is new Block_Cipher_Generic
     (Name_Intern            => "ARIA-192",
      Context_T_Intern       => ARIA_Spec.Context_T,
      Block_Size_Bits_Intern => 128,
   ...
   package ARIA_256 is new Block_Cipher_Generic
     (Name_Intern            => "ARIA-256",
      Context_T_Intern       => ARIA_Spec.Context_T,
      Block_Size_Bits_Intern => 128,
