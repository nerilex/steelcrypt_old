...
package body ARIA_Spec is
   ...
   procedure F_Odd
     (Block     : in out Block_128_Bit;
      Round_Key : in     Block_128_Bit)
   is
   begin
...
--        end if;
      ...
      Context.W (3) :=
        PreKey_T (u8_Array (Context.W (3)) xor u8_Array (Context.W (1)));
      Context.W (4) := Context.W (3);
      F_Odd (Block_128_Bit (Context.W (4)), C (C_Select (3)));
      Context.W (4) :=
        PreKey_T (u8_Array (Context.W (4)) xor u8_Array (Context.W (2)));
   end Initialize;
   ...
   begin
      for i in 0 .. Integer (Context.Rounds) - 2 loop
         temp_key :=
           u8_Array (Context.W ((i mod 4) + 1)) xor
           Rotate_be
             (u8_Array (Context.W (((i + 1) mod 4) + 1)),
              Rotation_Constants ((i / 4) + 1));
      ...
      temp_key :=
        u8_Array (Context.W ((n mod 4) + 1)) xor
        Rotate_be
          (u8_Array (Context.W (((n + 1) mod 4) + 1)),
           Rotation_Constants ((n / 4) + 1));
