...
package TDES is
   ...
   package TDES_Two_Key is new Block_Cipher_Generic
     (Name_Intern            => "Triple-DES (two keys)",
   ...
   package TDES_Three_Key is new Block_Cipher_Generic
     (Name_Intern            => "Triple-DES (three keys)",
      Context_T_Intern       => TDES_Spec.Context_T,
      Block_Size_Bits_Intern => 64,
