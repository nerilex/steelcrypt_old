...
package SHA3 is
   ...
   package SHA3_224 is new Hash_Generic
     (Name_Intern             => "SHA3-224",
   ...
   package SHA3_256 is new Hash_Generic
     (Name_Intern             => "SHA3-256",
   ...
   package SHA3_384 is new Hash_Generic
     (Name_Intern             => "SHA3-384",
   ...
   package SHA3_512 is new Hash_Generic
     (Name_Intern             => "SHA3-512",
